                                ...
                                <div class="d-flex justify-content-center align-items-center flex-column">
                                    <div class="avatar avatar-xl">
                                        @if (Auth::user()->foto === null)
                                            <img width="150" class="gambar rounded-circle"
                                                src="{{ asset('assets/no-cover.jpg') }}" alt="Avatar">
                                        @else
                                    ...
                                    <div class="mt-3">
                                        <input type="file" class="form-control py-1 @error('foto') is-invalid @enderror"
                                        ...
                                        <div class="mt-3">
                                            <img src="" class="img-preview img-thumbnail" alt=""
                                                width="250px" height="50px" hidden>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="form-group m-2">
                                <button type="submit" class="btn-primary"
                                    style="width:125px; border-radius:8px; height: 38px">Save</button>
                            </div>
                        </div>
                    </div>
                </div>

                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('job') is-invalid @enderror" id="job"
                                    placeholder="Job" name="job" value="{{ old('job', $job->job) }}" autofocus>
                            </div>
                            @error('job')
                                ...
                                <select name="tbl_category_id" class="form-control" id="tbl_category_id" required>
                                    ...
                                    @foreach (App\Models\tblCategory::all() as $category)
                                        <option value="{{ $category->id }}"
                                            {{ $category->id == $job->tbl_category_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <select name="tbl_company_id" class="form-control" id="tbl_company_id" required>
                                    <option selected disabled>Pilih Company Job</option>
                                    @foreach (App\Models\tblCompany::all() as $company)
                                        <option value="{{ $company->id }}"
                                            {{ $company->id == $job->tbl_company_id ? 'selected' : '' }}>
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <select name="is_open" class="form-control" id="is_open" required>
                                    <option>Pilih</option>
                                    <option value="1" {{ $job->is_open ? 'selected' : '' }}>Yes</option>
                                    <option value="0" {{ !$job->is_open ? 'selected' : '' }}>No</option>
                                </select>
                            </div>
                        </div>
                    </div>

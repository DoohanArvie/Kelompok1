                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('job') is-invalid @enderror" id="job" placeholder="Job" name="job" value="{{ old('job') }}" autofocus>
                        </div>
                        @error('job')
                ...
                <div class="col-md-6">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('requirement') is-invalid @enderror" id="requirement" name="requirement">{{ old('requirement') }}</textarea>
                        </div>
